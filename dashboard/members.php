...
<body class="bg-light">
    ...
    <div class="main-content">
        <div class="welcome-section">
            <h1 class="display-5"><i class="fas fa-users"></i> Members Management</h1>
            <p class="lead">View and manage all registered users in the system.</p>
        </div>
        ...
        <div class="table-container">
            <h2 class="mb-4"><i class="fas fa-users"></i> All Members</h2>
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            $registrationDate = isset($row['created_at']) ? date('M d, Y', strtotime($row['created_at'])) : 'N/A';
